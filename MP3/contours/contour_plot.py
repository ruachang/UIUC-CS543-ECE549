...
FLAGS = flags.FLAGS
flags.DEFINE_list('dirs', ["output/demo/warm-up", "output/demo/gaussian-2d", "output/demo/nms", "output/demo/extra"], 
                  'List of directories to read metrics from')
flags.DEFINE_list('names', ['warm up', 'gaussian 2d', 'nms', 'threshold'], 
                  'Legends')
